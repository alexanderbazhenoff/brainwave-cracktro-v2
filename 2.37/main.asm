...
; this file, You can obtain one at ttps://github.com/aws/mit-0
        ...
        ENDM 
        DISPLIN
 DISPLAY "|   bra!nwave crack7r0 v2.37 c0ded b4 alx^bw.   |"
        DISPLIN
 DISPLAY 
...
LOPRIL  LD A,(DE)
        ...
        RST #10
        JR LOPRIL
LTEXTD  DB #10,7,#11,0,#13,1,#16,10,6
        DB "LOADING SAVAGE DEMO"
        DB #FF
LTEXTL  DB #10,7,#11,1,#16,1,7
        DB " SAVAGE - LEVEL "
LTEXLEV DB "  "
        DB #FF
        ENT 
