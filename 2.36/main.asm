...
; this file, You can obtain one at ttps://github.com/aws/mit-0
        ...
        ENDM 
        DISPLIN
 DISPLAY "|   bra!nwave crack7r0 v2.36 c0ded b4 alx^bw.   |"
        DISPLIN
 DISPLAY 
...
TR_ACT  EQU 0           ;IF =0 - TRAINER MENUE OFF
OPT     EQU 0
...
PA      EQU 1   ;для 3-х частей
CCR     EQU 1
PAGS    EQU 7   ;кол-во стр. текста
PASC    EQU 0   ;для 2-х частей

        IF0 GA
        DISPLAY /L,"I, BALL COLLECTION"
TR_ACT=1
TR_POI=6
TR_YEP=29
CCR=0
PASC=1
        ENDIF 
        IF0 GA-1
        DISPLAY /L,"CYBERNOID COLLECTION"
        COLRMOD2
TR_ACT=1
TR_POI=6
TR_YEP=29
...
CCR=0
        ENDIF 
        IF0 GA-3
        DISPLAY /L,"INTERNATIONAL 3D TENNIS";***
        COLRMOD2
TR_POI=0
TR_YEP=0
OPT=1
...
FONT    INCBIN "funyfnt_"
ENDCOD
LOGO    INCBIN "crac2log"
...
LOADER
        ...
        LD E,.TEXTPRT2
P_PART1
        LD BC,TEXTPRT2-TEXTPRT1+2
        CALL 8252
        LD HL,#6000
        LD B,#7
        JP #5D7C

TEXTPRT1 DB #10,7,#11,1,#16,1,11," I, BALL "
TEXTPRT2 DB #10,7,#11,1,#16,1,10," I, BALL 2 "
        ENT 
ENDLOADER
        ENDIF 
